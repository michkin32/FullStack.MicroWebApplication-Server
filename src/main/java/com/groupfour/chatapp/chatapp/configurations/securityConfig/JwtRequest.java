...
public class JwtRequest extends OncePerRequestFilter {
    ...
    public JwtRequest(JwtToken jwtTokenUtil) {
...
//    @Autowired
//    private JwtUserDetailsService jwtUserDetailsService;  //TODO need to match bean https://dzone.com/articles/spring-boot-security-json-web-tokenjwt-hello-world
//    @Autowired
